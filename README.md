...
**rails-budget-app** ia mobile web application where you can manage your budget: you have a list of transactions associated with a category, so that you can see how much money you spent and on what.
...
- **Sintroduce new transactions associated with a category.**
...
`bin/rails test file_path/file_name.rb`
...
- Microverse for inspriring this project idea
